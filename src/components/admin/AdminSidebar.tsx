...
const navItems = [
  ...
  { href: '/admin/lead-magnets', label: 'Lead Magnets', icon: 'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-dark-900 border-r border-dark-800 min-h-screen flex flex-col shrink-0">
      <div className="p-6 border-b border-dark-800">
        <Link href="/admin" className="text-lg font-bold text-white">
          SS360 <span className="text-primary-500">Admin</span>
        </Link>
      </div>
