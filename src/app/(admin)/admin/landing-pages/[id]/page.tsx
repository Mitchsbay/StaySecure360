...
export default function EditLandingPagePage() {
  ...
  const fetchLandingPage = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        setHeroImageAlt(data.hero_image_alt || '');
        setIntro(data.intro || '');
        setBenefits(data.benefits || []);
        setSections(data.sections || []);
        setFaqs(data.faqs || []);
        setCtaLabel(data.cta_label || 'View Product');
      ...
      setError('An error occurred while loading the landing page');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error:', err);
      setError('An error occurred while updating the landing page');
      setSaving(false);
    }
  };
  ...
  const handleDuplicate = async () => {
    ...
    setDuplicating(true);
    try {
      const newSlug = `${landingPage.slug}-copy`;
        ...
        .insert([
          {
            ...
            hero_image_alt: landingPage.hero_image_alt,
            intro: landingPage.intro,
            benefits: landingPage.benefits,
            sections: landingPage.sections,
            faqs: landingPage.faqs,
            cta_label: landingPage.cta_label,
            cta_url: landingPage.cta_url,
            primary_keyword: landingPage.primary_keyword,
            secondary_keywords: landingPage.secondary_keywords,
      ...
      <AdminLayout>
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <p className="text-dark-400">Loading landing page...</p>
          </div>
        </div>
      </AdminLayout>
    );
      ...
      <AdminLayout>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-dark-400 mt-2">The landing page you're looking for doesn't exist.</p>
          </div>
          <button
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-white">Edit Landing Page</h1>
            <p className="text-dark-400 mt-2">Update landing page information</p>
          </div>
          <button
            onClick={handleDuplicate}
            disabled={duplicating}
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors disabled:opacity-50 font-medium self-start sm:self-auto"
          >
